...
class DeepSpeech(nn.Module):
    ...
    @staticmethod
    def serialize(model, optimizer=None, epoch=None, iteration=None, loss_results=None,valid_results=None,
                  cer_results=None, wer_results=None, lr_results=None, avg_loss=None, meta=None):
        ...
        if loss_results is not None:
            ...
            package['valid_results'] = valid_results
            package['cer_results'] = cer_results
            package['wer_results'] = wer_results
            package['lr_results'] = lr_results
        if meta is not None:
            package['meta'] = meta
        return package
