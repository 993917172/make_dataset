...
parser.add_argument('--log_dir', default='visualize/', help='Location of tensorboard log')
...
parser.set_defaults(cuda=True, silent=False, checkpoint=True, visdom=False, augment=False, tensorboard=True,
