...
from Chinese_decoder import GreedyDecoder
...
parser.add_argument('--save_folder', default='models_thchs30/', help='Location to save epoch models')
parser.add_argument('--model_path', default='models_thchs30/deepspeech_final.pth.tar',
...
parser.add_argument('--log_dir', default='visualize_thchs30/', help='Location of tensorboard log')
...
def main():
    ...
    if args.continue_from:
        ...
        loss_results, valid_results, cer_results, wer_results, lr_results = package['loss_results'], package['valid_results'], package[
